...
describe('Enigma tests', () => {
  ...
  it('should deploy secret contract', async () => {
    ...
    console.log('Deployed calculator with address:', scTask.scAddr);
    fs.writeFile(path.join(homedir, '.enigma', 'addr-calculator.txt'), scTask.scAddr, { flag: 'w', encoding: 'utf8' }, function (err) {
      if (err) {
